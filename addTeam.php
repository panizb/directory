...
<html>
  ...
  <body>
    <div class="jumbotron">
      <div class="container">
        <div id="addTModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
                  ...
                  <div class="modal-body" style="padding:40px 50px;">
                          <form role="form" action="manipulate.php?userID=<?php echo $_GET['userID'];?>" >
                            <div class="form-group">
                              <label for="usrname"><span class="glyphicon glyphicon-asterisk"></span> Team Name</label>
